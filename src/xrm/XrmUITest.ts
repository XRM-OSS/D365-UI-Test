...
/**
 * @summary Parameters for opening Dynamics
 */
export interface OpenProperties {
    /**
     * @summary ID of the Dynamics app to open after login
     */
    appId?: string;

    /**
     * @summary Username / email to use for logging in. If left out, it is assumed that CRM does not need explicit authentication (i.e. SSO)
     */
    userName?: string;

    /**
     * @summary Password to use for logging in. If left out, SSO is assumed.
     */
    password?: string;

    /**
     * @summary CSS selector for typing user name / email on login page. Needed for custom authentication pages of ADFS only.
     */
    userNameFieldSelector?: string;

    /**
     * @summary CSS selector for typing password on login page. Needed for custom authentication pages of ADFS only.
     */
    passwordFieldSelector?: string;

    /**
     * @summary Secret which you generated for using MFA. Only needed if you actually use MFA
     */
    mfaSecret?: string;

    /**
     * @summary Enter css selector for mfaInput, if you use a non MS default MFA provider. If none provided, we will try finding the MS token input
     */
    mfaFieldSelector?: string;

    /**
     * @summary If you use a non MS MFA provider and need to switch a toggle first before being able to insert token, specify the toggle field selector that has to be clicked before entering the MFA token here
     */
    mfaToggleFieldSelector?: string;
}

/**
 * @summary Main class for testing in D365
 */
export class XrmUiTest {
    ...
    /**
     * @summary Default settings for various actions such as navigation
     */
    get settings() {
    ...
    /**
     * @summary Gets the browser object that was generated when launching playwright
     */
    get browser() {
    ...
    /**
     * @summary Gets the browser context object
     */
    get context() {
    ...
    /**
     * @summary Gets the page object that was generated when connecting to D365
     */
    get page() {
        return this._page;
    }
    ...
    /**
     * @summary Gets the D365 base URL
     */
    get crmUrl() {
        return this._crmUrl;
    }
    ...
    /**
     * @summary Gets the subfunctions for navigating in D365
     */
    get Navigation() {
        if (!this._navigation) {
    ...
    /**
     * @summary Gets the subfunctions for using ribbon buttons in D365
     */
    get Button() {
        if (!this._button) {
    ...
    /**
     * @summary Gets the subfunctions for interacting with the record in D365
     */
    get Entity() {
        if (!this._entity) {
    ...
    /**
     * @summary Gets the subfunctions for interacting with attributes in D365, for example getting or setting values
     */
    get Attribute() {
        if (!this._attribute) {
    ...
    /**
     * @summary Gets the subfunctions for interacting with controls in D365, for example getting visibility or disable states
     */
    get Control() {
        if (!this._control) {
    ...
    /**
     * @summary Gets the subfunctions for interacting with dialogs in D365, for example duplicate detection dialogs
     */
    get Dialog() {
        if (!this._dialog) {
    ...
    /**
     * @summary Gets the subfunctions for interacting with forms in D365, for example opening different forms
     */
    get Form() {
        if (!this._form) {
    ...
    /**
     * @summary Gets the subfunctions for interacting with subgrids in D365, for example refreshing or opening specific records
     */
    get SubGrid() {
        if (!this._subGrid) {
    ...
    /**
     * @summary Gets the subfunctions for interacting with tabs in D365, for example to open one
     */
    get Tab() {
        if (!this._tab) {
    ...
    /**
     * @summary Gets the currently opened AppId
     */
    get AppId() {
        return this._appId;
    }
    ...
    /**
     * @summary Sets the currently opened AppId. Is set automatically by calling Navigation.openAppById
     */
    set AppId(value) {
        this._appId = value;
    }
    ...
    /**
     * @summary Waits for all pending UCI operations to settle
     */
    ...
    /**
     * @summary Opens your D365 organization and logs you in
    ...
    /**
     * @summary Closes the playwright browser session
     */
    close = async () => {
